...
export default function LegalReader() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form onSubmit={handleAnalyze} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-4 shadow-sm">
        <div className="flex gap-2 p-1 bg-slate-100 dark:bg-slate-700/50 rounded-lg w-fit">
          <button
            type="button"
        ...
        {mode === 'file' ? (
          <div
            className="border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-xl p-8 text-center cursor-pointer hover:border-primary-400 dark:hover:border-primary-500 transition-colors"
